...
// ../sdk/dist/client.js
var TinysendError = class extends Error {
  status;
  code;
...
var ApiClient = class {
  ...
  constructor(apiKey, options2 = {}) {
    this.apiKey = apiKey;
    this.baseUrl = (options2.baseUrl ?? "https://api.tinysend.com/v1").replace(/\/$/, "");
    this._fetch = options2.fetch ?? globalThis.fetch.bind(globalThis);
  }
...
// ../sdk/dist/resources/subscribers.js
...
var MailboxEmails = class {
  ...
  update(mailboxId, emailId, params) {
...
// ../sdk/dist/resources/webhooks.js
var Webhooks = class {
  client;
  constructor(client) {
    this.client = client;
...
// ../sdk/dist/resources/site-domains.js
var SiteDomains = class {
  client;
  constructor(client) {
    this.client = client;
  }
...
// ../sdk/dist/resources/automations.js
var Automations = class {
  ...
  async list() {
    const resp = await this.client.get("/automations");
    return resp.data;
  }
  get(id) {
...
var Invites = class {
  ...
  async list() {
    const resp = await this.client.get("/invites");
    return resp.data;
  }
  approve(id) {
...
// ../sdk/dist/resources/settings.js
var Settings = class {
  client;
  constructor(client) {
    this.client = client;
...
var Tinysend = class {
  ...
  settings;
  constructor(apiKey, options2) {
    const client = new ApiClient(apiKey, options2);
...
function requireInput(name) {
  ...
  if (value === void 0) fail(`missing required input: ${name}`);
  return value;
}
...
async function main() {
  ...
  const raw = bodyFile ? (0, import_node_fs.readFileSync)(bodyFile, "utf8") : input("body");
  if (raw === void 0) fail("provide body or body-file");
  const params = format === "html" ? { subject, body_html: raw } : format === "text" ? { subject, body_text: raw } : { subject, body_html: marked.parse(raw, { async: false }) };
